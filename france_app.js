...
// Import Data
d3.csv("France.csv").then(function(FranceWineData) {

    // Step 1: Parse Data/Cast as numbers
    // ==============================
    FranceWineData.forEach(function(data) {
    ...
    var xLinearScale = d3.scaleLinear()
      .domain([0, d3.max(FranceWineData, d => d.price)])
      .range([0, width]);

    var yLinearScale = d3.scaleLinear()
      .domain([75, d3.max(FranceWineData, d => d.points)])
      .range([height, 0]);
